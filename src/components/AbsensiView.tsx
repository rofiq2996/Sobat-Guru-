                    ...
                    {['Hadir', 'Izin', 'Sakit', 'Alpa'].map((s) => (
                      <button 
                        ...
                        className={`text-xs w-8 h-8 flex items-center justify-center rounded-md font-bold transition-colors disabled:opacity-60 disabled:cursor-not-allowed ${
                          student.status === s 
                            ? (s === 'Hadir' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' 
                                : s === 'Izin' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400'
                                : s === 'Sakit' ? 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400'
